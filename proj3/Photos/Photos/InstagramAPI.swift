        ...
        let task = NSURLSession.sharedSession().dataTaskWithURL(url) {
            ...
            if error == nil {
                ...
                do {
                    ...
                    let popularObjects = feedDictionary.valueForKey("data") as! [NSDictionary]
                    for objectDictionary in popularObjects {
                        if (objectDictionary.valueForKey("type") as! String) == "image" {
                            photos.append(Photo(data: objectDictionary))
                        }
                    }
